...
inline bool Cheat::Renderer::Init()
{
    ...
    Logger::Log("dxgi: %p\n", dxgi);
    // 11.06 static BYTE PresentSig[] = { 0x55, 0x57, 0x41, 0x56, 0x48, 0x8d, 0x6c, 0x24, 0x90, 0x48, 0x81, 0xec, 0x70, 0x01 };
    ...
    // 11.06 static BYTE ResizeSig[] = { 0x48, 0x81, 0xec, 0xc0, 0x00, 0x00, 0x00, 0x48, 0xc7, 0x45, 0x1f }; 
