...
struct APlayerState //3D0 old 3D4 3D8 old // 
{
	char pad[0x3c8];
...
// pad_04f8[1059]->1031->1069  ??? ha valami nem jo ide vissza nemtom
struct AController {

	char pad_0000[0x3e0];
	class ACharacter* Character; //0x03E8 // 0x440(0x8) talán?  0x3e0 most?
	char pad_0480[0x70];
	APlayerCameraManager* PlayerCameraManager; // 0x0458(0x0008)
	char pad_04f8[0x10F1];
	bool IdleDisconnectEnabled;//0x1551(0x1)
...
struct AFauna {
	char pad1[0x818];
	FString* DisplayName; // 0x0808 old
};
...
struct ASharkPawn {
	char pad1[0x4c0];
	USkeletalMeshComponent* Mesh; // 0x04C8 OLD // 0x4c0(0x8)
	char pad2[0x64]; // 0x5C OLD 0x64new?
	ESwimmingCreatureType SwimmingCreatureType; // 0x052C OLD //0x524(0x1)
};
...
struct UWieldedItemComponent {
	char pad[0x02F0]; // 2c0 old
	ACharacter* CurrentlyWieldedItem; // 0x02E0 //2F0 new?
};
...
struct AProjectileWeapon {
	char pad[0x7D0];
	FProjectileWeaponParameters WeaponParameters; // 0x7d0 old // 0x7c8(0x1e8)
...
struct AIslandService {
	char pad[0x0458]; // 460 old
	UIslandDataAsset* IslandDataAsset; // 0x458
};

struct ASlidingDoor {
	char pad_0x0[0x534]; //52C old
...
struct APuzzleVault {
	char pad[0x1020]; //0x1000 old
	ASlidingDoor* OuterDoor; // 0x1020(0x8)
};
...
struct ACrewService {
	char pad[0x04A0]; // 0x4A8 OLD
	TArray<FCrew> Crews; // 0x04A0
};

struct AShip
{
	char pad1[0x1052]; // 0xFD2 OLD
	bool                                               EmissaryFlagActive;                                        // 0x1052(0x0001) (Net, ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct AAthenaGameState {
	...
	struct AContestManagerService* ContestManagerService; // 0x678(0x08)
	struct ADrawDebugService* DrawDebugService; // 0x680(0x08)
	struct AWorldEventZoneService* WorldEventZoneService; // 0x688(0x08)
	struct UWorldResourceRegistry* WorldResourceRegistry; // 0x690(0x08)
	struct AKrakenService* KrakenService; // 0x698(0x08)
	struct UPlayerNameService* PlayerNameService; // 0x6a0(0x08)
	struct ATinySharkService* TinySharkService; // 0x6a8(0x08)
	struct AProjectileService* ProjectileService; // 0x6b0(0x08)
	struct ULaunchableProjectileService* LaunchableProjectileService; // 0x6b8(0x08)
	struct UServerNotificationsService* ServerNotificationsService; // 0x6c0(0x8)
	struct AAIManagerService* AIManagerService; // 0x6c8(0x8)
	struct AAIEncounterService* AIEncounterService; // 0x6d0(0x8)
	struct AAIEncounterGenerationService* AIEncounterGenerationService; // 0x6d8(0x8)
	struct UEncounterService* EncounterService; // 0x6e0(0x8)
	struct UGameEventSchedulerService* GameEventSchedulerService; // 0x6e8(0x8)
	struct UHideoutService* HideoutService; // 0x6f0(0x8)
	struct UAthenaStreamedLevelService* StreamedLevelService; // 0x6f8(0x8)
	struct ULocationProviderService* LocationProviderService; // 0x700(0x8)
	struct AHoleService* HoleService; // 0x708(0x8)
	struct APlayerBuriedItemService* PlayerBuriedItemService; // 0x710(0x8)
	struct ULoadoutService* LoadoutService; // 0x718(0x8)
	struct UOcclusionService* OcclusionService; // 0x720(0x8)
	struct UPetsService* PetsService; // 0x728(0x8)
	struct UAthenaAITeamsService* AthenaAITeamsService; // 0x730(0x8)
	struct AAllianceService* AllianceService; // 0x738(0x8)
	struct UMaterialAccessibilityService* MaterialAccessibilityService; // 0x740(0x8)
	struct AReapersMarkService* ReapersMarkService; // 0x750(0x8)
	struct AEmissaryLevelService* EmissaryLevelService; // 0x758(0x8)
	struct ACampaignService* CampaignService; // 0x768(0x8)
	struct AStoryService* StoryService; // 0x770(0x8)
	struct AStorySpawnedActorsService* StorySpawnedActorsService; // 0x778(0x8)
	struct UGlobalVoyageDirectorService* GlobalVoyageDirector; // 0x788(0x8)
	struct AFlamesOfFateSettingsService* FlamesOfFateSettingsService; // 0x790(0x8)
	struct AServiceStatusNotificationsService* ServiceStatusNotificationsService; // 0x798(0x08)
	struct UMigrationService* MigrationService; // 0x7a0(0x8)
	struct AShroudBreakerService* ShroudBreakerService; // 0x7b0(0x8)
	struct UServerUpdateReportingService* ServerUpdateReportingService; // 0x7b8(0x8)
	struct AGenericMarkerService* GenericMarkerService; // 0x7c0(0x8)
	struct AMechanismsService* MechanismsService; // 0x7c8(0x8)
	struct UMerchantContractsService* MerchantContractsService; // 0x7d0(0x8)
	struct UShipFactory* ShipFactory; // 0x7d8(0x8)
	struct URewindPhysicsService* RewindPhysicsService; // 0x7e0(0x8)
	struct UNotificationMessagesDataAsset* NotificationMessagesDataAsset; // 0x7e8(0x8)
	struct AProjectileCooldownService* ProjectileCooldownService; // 0x7f0(0x8)
	struct UIslandReservationService* IslandReservationService; // 0x7f8(0x8)
	struct APortalService* PortalService; // 0x800(0x8)
	struct UMeshMemoryConstraintService* MeshMemoryConstraintService; // 0x808(0x8)
	struct ABootyStorageService* BootyStorageService; // 0x810(0x8)
	struct ASpireService* SpireService; // 0x820(0x8)
	struct AFireworkService* FireworkService; // 0x828(0x8)
	struct UAirGivingService* AirGivingService; // 0x838(0x8)
	struct UCutsceneService* CutsceneService; // 0x840(0x8)
	struct ACargoRunService* CargoRunService; // 0x848(0x8)
	struct ACommodityDemandService* CommodityDemandService; // 0x850(0x8)
	struct ADebugTeleportationDestinationService* DebugTeleportationDestinationService; // 0x858(0x8)
	struct ASeasonProgressionUIService* SeasonProgressionUIService; // 0x860(0x8)
	struct UTransientActorService* TransientActorService; // 0x868(0x8)
	struct UTunnelsOfTheDamnedService* TunnelsOfTheDamnedService; // 0x870(0x8)
	struct UWorldSequenceService* WorldSequenceService; // 0x878(0x8)
	struct UItemLifetimeManagerService* ItemLifetimeManagerService; // 0x880(0x8)
	struct ASeaFortsService* SeaFortsService; // 0x890(0x8)
	struct ABeckonService* BeckonService; // 0x8a0(0x8)
	struct UVolcanoService* VolcanoService; // 0x8a8(0x8)
	struct UShipAnnouncementService* ShipAnnouncementService; // 0x8b0(0x8)
	struct AShipsLogService* ShipsLogService; // 0x8b8(0x8)
};
...
public:
	...
	APlayerState* PlayerState;  // 0x03F0									// 0x3e8(0x8)
	char pad2[0x10];
	AController* Controller;// 0x400(0x8)
	char pad3[0x38];
	USkeletalMeshComponent* Mesh; // 0x440(0x8)
	UCharacterMovementComponent* CharacterMovement;// 0x448(0x8)
	char pad4[0x3E0];
	...
	char pad6[0x4D0];
	UDrunkennessComponent* DrunkennessComponent; // 0xd30(0x8)
	char pad7[0x8];
	UDrowningComponent* DrowningComponent;// 0xd40(0x8)
